    ...
    $.ajax({
        ...
        success: function( response ) {                                       
            if (response == -1){
                ...
                location.href= "/win/owa/ibe5_ext.check_itin?hotel=152&lang=1&conf=" + response;
            }
        }
    });
    return false;
    ...
    $.ajax({
        ...
        success: function( response ) {                                       
            if (response == -1){
                ...
                location.href= "/win/owa/ibe5_ext.check_itin?hotel=152&lang=1&conf=" + response + "&lastname=" + $("#lastname3").val();
            }
        }
    });
    return false;
    ...
    $.ajax({
        ...
        success: function( response ) {                                       
            if (response == -1){
                ...
                location.href= "/win/owa/ibe5_ext.check_itin?hotel=152&lang=1&conf=" + response + "&lastname=" + $("#lastname2").val();
            }
        }
    });
    return false;
...
var cur_conv = 1;
    ...
    $('#next-step').on('click', function(event){
        ...
        var ageBox='';
        var ageOption='';
        var today = new Date(2021,3,21);
        var aD = new Date(2021,3,21);
...
ageOption+='<option value="12">12</option>';
    ...
    function parse_rates(xml) {   
        ...
        $.ajax({
            ...
            error: function(res, textStatus, errorThrown){
                get_data('31-MAR-21','30-SEP-21', textStatus + errorThrown.substring(0, 20));
            }
        });  */

        
        if(typeof CAL_XML === "undefined"){
            get_data('31-MAR-21','30-SEP-21', "File Not Found");
        } else {
            try{
        ...
        $.ajax({
            ...
            data: {
                ...
                xStartDate: startDate?startDate:'21-APR-21',
    ...
    if ($('.travel-calendar').length > 0) {
        ...
        var temp1 = new Date(2021,3,21);
        var temp2 = new Date(2021,3,21);
var temp3 = new Date();

        var temp4 = new Date(2021,5,21);
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=10284&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">THE REEF COCOBEACH</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=10284&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">THE REEF COCOBEACH</p></a>';
